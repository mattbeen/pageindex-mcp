...
# Optional override: PAGEINDEX_ENV_FILE=/path/to/.env
_env_file = os.getenv("PAGEINDEX_ENV_FILE")
if _env_file:
...
class ConfigLoader:
    def __init__(self, default_path: str = None):
        if default_path is None:
            # Optional override: PAGEINDEX_CONFIG_PATH=/path/to/config.yaml
            default_path = os.getenv("PAGEINDEX_CONFIG_PATH") or str(
